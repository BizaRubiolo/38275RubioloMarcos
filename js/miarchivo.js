...
titulo.innerText = "DESAFIO 5 - INTERACTUANDO CON HTML"
...
//Uso de los 3 pasos para agregar nodos con append
let despedida = document.createElement("h3")
despedida.innerHTML = "MUCHAS GRACIAS POR SU COMPRA !!!"
document.body.append(despedida)
...
//Bienvenida anterior comentada y nueva
//alert("BIENVENIDO A NUESTRO HOT SALE !!!\nVEA NUESTRAS OFERTAS !!!");

let prodHTML = document.getElementById("prodHTML")

for (const prod of listaProductos) {
    let list = document.createElement("li")
    list.innerHTML = `${prod.tipo} ${prod.marca} ${prod.modelo}  <b>$${prod.precio}</b>`
    prodHTML.appendChild(list)
}
